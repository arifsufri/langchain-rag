...
async function main() {
  try {
    console.log('🔍 Advanced Retrieval Strategies Demo with Ollama (FREE!)\n');
    ...
    console.log('\n🎉 All done with FREE Ollama - no API costs!\n');
